...
import com.amazonaws.apollographql.apollo.cache.GraphQLCacheHeaders;
...
public interface GraphQLCall<T> extends Cancelable {
  ...
  /**
   * Sets the {@link CacheHeaders} to use for this call. {@link com.amazonaws.apollographql.apollo.interceptor.FetchOptions} will
