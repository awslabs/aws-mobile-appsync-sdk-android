...
import com.amazonaws.apollographql.apollo.compiler.Annotations
import com.amazonaws.apollographql.apollo.compiler.InputTypeSpecBuilder
...
data class TypeDeclaration(
  ...
  private fun inputObjectToTypeSpec(context: CodeGenerationContext) =
      InputTypeSpecBuilder(name, fields
              ?: emptyList(), context).build()
