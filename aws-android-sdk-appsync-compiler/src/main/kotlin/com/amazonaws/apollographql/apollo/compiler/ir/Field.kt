...
import com.amazonaws.apollographql.apollo.compiler.*

import com.squareup.javapoet.*
import java.util.*
import javax.lang.model.element.Modifier
import com.amazonaws.apollographql.apollo.compiler.ClassNames.S3Object
...
data class Field(
  ...
  private fun toTypeName(responseType: String, context: CodeGenerationContext): TypeName {
    ...
    return JavaTypeResolver(context, packageName, isDeprecated
            ?: false).resolve(responseType, isOptional())
  }
