...
* Fixed bug that was causing a ConcurrentModificationException in the logic to handle connection loss. See [PR #22](https://github.com/awslabs/aws-mobile-appsync-sdk-android/pull/22) and [issue #53](https://github.com/awslabs/aws-mobile-appsync-sdk-android/issues/53)
